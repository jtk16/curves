...
public class JunctionAligner {
    ...
    public static double[] RedyCrCbMin = new double[] {0, 160, 0};
    public static double[] RedyCrCbMax = new double[] {200, 255, 120};
    public static double[] BlueyCrCbMin = new double[] {0, 0, 120};
    public static double[] BlueyCrCbMax = new double[] {200, 120, 255};
    ...
    public static void main(String[] poop) {
        ...
        while (true) {
            if (1000d/frameRate > System.currentTimeMillis()-previousTime) {
                ...
                Core.inRange(img, new Scalar(BlueyCrCbMin[0], BlueyCrCbMin[1], BlueyCrCbMin[2]), new Scalar(BlueyCrCbMax[0], BlueyCrCbMax[1], BlueyCrCbMax[2]), binary);
